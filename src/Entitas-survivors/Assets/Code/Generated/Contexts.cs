...
public partial class Contexts {
    ...
    public void InitializeEntityIndices() {
        ...
        game.AddEntityIndex(new Entitas.EntityIndex<GameEntity, Assets.Code.Gameplay.Features.Abilities.AbilityId>(
            ParentAbility,
            game.GetGroup(GameMatcher.ParentAbility),
            (e, c) => ((Assets.Code.Gameplay.Features.Abilities.ParentAbility)c).Value));
    }
}
...
public static class ContextsExtensions {
    ...
    public static System.Collections.Generic.HashSet<GameEntity> GetEntitiesWithParentAbility(this GameContext context, Assets.Code.Gameplay.Features.Abilities.AbilityId Value) {
        return ((Entitas.EntityIndex<GameEntity, Assets.Code.Gameplay.Features.Abilities.AbilityId>)context.GetEntityIndex(Contexts.ParentAbility)).GetEntities(Value);
    }
}
//------------------------------------------------------------------------------
// <auto-generated>
