...
public partial class GameEntity {
    ...
    public Assets.Code.Gameplay.Features.Armaments.StatusSetups statusSetups { get { return (Assets.Code.Gameplay.Features.Armaments.StatusSetups)GetComponent(GameComponentsLookup.StatusSetups); } }
    ...
    public GameEntity AddStatusSetups(System.Collections.Generic.List<Assets.Code.Gameplay.Features.Statuses.StatusSetup> newValue) {
        ...
        var component = (Assets.Code.Gameplay.Features.Armaments.StatusSetups)CreateComponent(index, typeof(Assets.Code.Gameplay.Features.Armaments.StatusSetups));
