...
public partial class GameEntity {
    ...
    public Assets.Code.Gameplay.Features.Armaments.TargetLimit targetLimit { get { return (Assets.Code.Gameplay.Features.Armaments.TargetLimit)GetComponent(GameComponentsLookup.TargetLimit); } }
    ...
    public GameEntity AddTargetLimit(int newValue) {
        ...
        var component = (Assets.Code.Gameplay.Features.Armaments.TargetLimit)CreateComponent(index, typeof(Assets.Code.Gameplay.Features.Armaments.TargetLimit));
