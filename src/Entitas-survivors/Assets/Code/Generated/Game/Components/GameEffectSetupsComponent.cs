...
public partial class GameEntity {
    ...
    public Assets.Code.Gameplay.Features.Armaments.EffectSetups effectSetups { get { return (Assets.Code.Gameplay.Features.Armaments.EffectSetups)GetComponent(GameComponentsLookup.EffectSetups); } }
    ...
    public GameEntity AddEffectSetups(System.Collections.Generic.List<Assets.Code.Gameplay.Features.Effects.EffectSetup> newValue) {
        ...
        var component = (Assets.Code.Gameplay.Features.Armaments.EffectSetups)CreateComponent(index, typeof(Assets.Code.Gameplay.Features.Armaments.EffectSetups));
