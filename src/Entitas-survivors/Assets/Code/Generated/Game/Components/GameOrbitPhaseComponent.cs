...
public partial class GameEntity {
    ...
    public Assets.Code.Gameplay.Features.Movement.OrbitPhase orbitPhase { get { return (Assets.Code.Gameplay.Features.Movement.OrbitPhase)GetComponent(GameComponentsLookup.OrbitPhase); } }
    ...
    public GameEntity AddOrbitPhase(float newValue) {
        ...
        var component = (Assets.Code.Gameplay.Features.Movement.OrbitPhase)CreateComponent(index, typeof(Assets.Code.Gameplay.Features.Movement.OrbitPhase));
